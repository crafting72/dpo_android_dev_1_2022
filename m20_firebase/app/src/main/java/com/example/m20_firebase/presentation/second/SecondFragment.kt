...
import com.example.m20_firebase.databinding.FragmentSecondBinding
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
                    ...
                    val text = "Photo saved on ${outputFileResults.savedUri}"
                    Toast.makeText(
                        requireContext(),
                        text,
                        Toast.LENGTH_SHORT
                    ...
                    viewModel.createNotification(requireContext(), text)
                }
